const textos = [
    ...
    <span class="lei">Cavaleiros só podem casar com escudeiros, <br>
     escudeiros com cavaleiros.</span><br>
    <span class="lei">Normais só podem casar com normais.</span>`,
    
    ` <strong>A BASE DE CONHECIMENTO É:</strong><br>
    A ilha de Bahava é <span class="civilizada">civilizada</span>: tanto os <span class="tipo homem">homens</span> como as <span class="tipo mulher">mulheres</span> podem ser cavaleiros, escudeiros ou normais.
    <span class="cavaleiros">Cavaleiros</span> dizem sempre a verdade.
    <span class="escudeiros">Escudeiros</span> mentem sempre.
    <span class="normais">Normais</span> dizem a verdade às vezes e mentem outras vezes.
    <span class="lei">Cavaleiros só podem casar com escudeiros, e escudeiros com cavaleiros.</span>
    <span class="lei">Normais só podem casar com normais.</span>`,
    ...
    ` `, //5
    ` `, //6
    ` <span class="lei">arrasta os blocos para os devidos lugares e <br>
    clica em responder. Podes repetir o questionário<br> quantas vezes quiseres ou clicar <br>
    em 'avançar' para saber a resposta</span>`, //7
    ``,  //8
    ``,  //9
    ``, //10
    `<span class="lei">arrasta os blocos para os devidos lugares e <br>
    clica em responder. Podes repetir o questionário<br> quantas vezes quiseres ou clicar <br>
    em 'avançar' para saber a resposta</span>`, //11
    ``, //12
    ``, //13
    ``, //14
    ``, //15
    ...
    `<span class="lei">arrasta os blocos para os devidos lugares e <br>
    clica em responder. Podes repetir o questionário<br> quantas vezes quiseres ou clicar <br>
    em 'avançar' para saber a resposta</span>`, //21
    ``, //22
    `` //23
    //``  //24
...
const imagensDestaque = {
    ...
    //5: "../assets/images/ilhaBahava/lex.png",
    //10: "../assets/images/ilhaBahava/lex.png"
};
...
const imagens = [
    "", //0
    "", //1
    "",//2     ""../assets/images/ilhaBahava3.png"
    "", //3
    "",  //4
    "../assets/images/ilhaBahava/banner puzzle.png", //5
    "../assets/images/ilhaBahava/banner puzzle.png", //6
    "../assets/images/ilhaBahava/banner puzzle.png", //7
    "", //8
    "../assets/images/ilhaBahava/banner puzzle.png",//9
    "../assets/images/ilhaBahava/banner puzzle.png",//10
    "../assets/images/ilhaBahava/banner puzzle.png", //11
    "",//12
    "",//13
    "../assets/images/ilhaBahava/banner puzzle.png", //14
    "../assets/images/ilhaBahava/banner puzzle.png", //15
    "", //16
    "../assets/images/ilhaBahava/banner puzzle.png", //17
    "../assets/images/ilhaBahava/banner puzzle.png", //18
    "../assets/images/ilhaBahava/banner puzzle.png", //19
    "../assets/images/ilhaBahava/banner puzzle.png", //20
    "../assets/images/ilhaBahava/banner puzzle.png", //21
    "", //22
    "" //23
];
...
const falasSmullyan = [
    ...
    ` Temos a Sra. A e o Sr. A , aqui ao lado.  Sabemos que são casados, portanto temos de ter em consideração a Lei da Imperatriz `,//3
    ...
    `Temos a Sra. A, o Sr. A, a Sra. B e o Sr. B` ,//9
    "", //10
